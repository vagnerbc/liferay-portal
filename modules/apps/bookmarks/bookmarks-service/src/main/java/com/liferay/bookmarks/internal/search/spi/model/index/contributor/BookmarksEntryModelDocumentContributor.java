...
public class BookmarksEntryModelDocumentContributor
	...
	public void contribute(Document document, BookmarksEntry bookmarksEntry) {
		...
		_addLocalizedFields(document, bookmarksEntry);
	}

	private void _addLocalizedFields(
		Document document, BookmarksEntry bookmarksEntry) {

		for (Locale locale :
				LanguageUtil.getAvailableLocales(bookmarksEntry.getGroupId())) {
